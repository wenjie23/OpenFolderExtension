...
namespace OpenFolderExtension.CommandCopyForAether
{
    internal sealed class CopyFilesForAetherItemNode
    {
        ...
        {
            Instance = new CopyFilesForAetherItemNode(package);
        }
        private CopyFilesForAetherItemNode(AsyncPackage package)
        {
